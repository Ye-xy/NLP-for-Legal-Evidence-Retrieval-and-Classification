# -*- coding: utf-8 -*-
"""05_Transformer_Encoder_TFIDF.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1m0yEXQPdxFI5B4t6BSP3O2ZZtV8psOaX
...
This section evaluates the transformer classifier trained on TFIDF-retrieved evidence. It includes:
...
model_path = "transformer_tfidf.pt"
epochs = 20
for t in range(epochs):
  print(f"Epoch {t + 1}\n-------------------------------")
...
# Save to file
with open("dev-claims-transformer-tfidf.json", "w") as f:
    json.dump(predictions, f, indent=2)

!python3 eval.py --predictions dev-claims-transformer-tfidf.json --groundtruth dev-claims.json
