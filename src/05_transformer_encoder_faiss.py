# -*- coding: utf-8 -*-
"""05_Transformer_Encoder_FAISS.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XdAiGS0k69Po6fdYr4ph1Wjp8dOH7ORJ
...
class FactCheckingDataset(Dataset):
    def __init__(self, claims_data, evidence_dict, retriever_fn, tokenizer,
                 max_length=128, top_k=5, inject=False):
...
This section evaluates the transformer classifier trained on FAISS-retrieved evidence. It includes:
...
model_path = "transformer_faiss.pt"
epochs = 20
for t in range(epochs):
  print(f"Epoch {t + 1}\n-------------------------------")
...
# Save to file
with open("dev-claims-transformer-faiss.json", "w") as f:
    json.dump(predictions, f, indent=2)

!python3 eval.py --predictions dev-claims-transformer-faiss.json --groundtruth dev-claims.json
